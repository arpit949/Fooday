	...
	<body>
		...
		<!-- Not found -->
		<section class="et-notfound position-relative">
			<div class="caption pt-4">
				<h1 class="display-1 font-weight-bold">404</h1>
				<p>
					Ooops! The page you are looking is not available or maybe broken.
				</p>
				<a href="#" class="btn shadow mt-2 bg-yellow text-capitalize text-white">back to home</a>
			</div>
		</section>
