								...
								<div class="col-md-4 mt-4">
									<div class="shadow-box bg-white p-0 restaurant">
										<div class="restaurant-thumbnail p-3 position-relative">
											...
											<img src="${i.profileImage }" style="height: 250px"
										...
										<div class="p-4">
											...
											<div class="d-flex align-items-center justify-content-center">
												<div
													...
													<p class="align-bottom d-inline-block m-0 pt-2">${i.deliveryCharges }
														&#x20B9</p>
												</div>
											</div>
											<a onclick='openRest("${i.loginvo.loginId}")'
									...
									<div class="d-sm-flex align-items-center">
										<div class="text-center pr-sm-3">
											<img style="width: 150px; height: auto; border-radius: 10px;"
												src="${i.profileImage}" class="d-block m-auto" alt="logo">
											<label class="rating small text-center"> <i
