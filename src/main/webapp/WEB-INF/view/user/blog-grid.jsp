	...
	<body>
		...
		<section class="et-page-title">
			<div class="container">
				<h1 class="text-white">Blog Grid <span class="icon-food d-block h1 mb-2"></span></h1>
				<ul>
		...
		<section class="container-fluid bg-alter et-news">
			<div class="section-heading text-center">
				<span class="icon-food d-block h1 mb-2"></span>
				<h2 class="text-capitalize font-weight-bold">latest <span class="text-yellow">news</span></h2>
				<p class="description mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing <br> elit, sed do eiusmod tempor</p>
			</div>
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="shadow-box mt-5 bg-white p-0 restaurant">
							<div class="restaurant-thumbnail p-3 position-relative">
								<small class="et-badge pl-2 pr-2 bg-danger text-white text-uppercase position-absolute">lifestyle</small>
								<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/176909027" style="position:absolute;top:0;border:0;left:0;width:100%;height:100%;" allow="autoplay; fullscreen" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
								<div class="restaurant-logo rounded-pill shadow overflow-hidden">
									<img src="<%=request.getContextPath()%>/restaurantResources/image/user-1.jpg" alt="img" class="img-fluid">
								</div>
							</div>
							<div class="p-4">
								<h5 class="font-weight-bold ellipsis"><a href="blog-detail.html" class="text-reset text-capitalize text-decoration-none">Rebirth of generation</a></h5>
								<p class="description">
									Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
								</p>
								<a href="blog-detail.html" class="btn pl-3 pr-3 shadow mt-3 mb-2 bg-yellow text-capitalize text-white">read more</a>
							</div>
						</div>
						<div class="shadow-box mt-5 bg-white p-0 restaurant">
							<div class="restaurant-thumbnail p-3 position-relative">
								<small class="et-badge pl-2 pr-2 bg-danger text-white text-uppercase position-absolute">travel</small>
								<img src="<%=request.getContextPath()%>/restaurantResources/image/restaurant-thumbnail-1.jpg" class="img-fluid" alt="mg">
								<div class="restaurant-logo rounded-pill shadow overflow-hidden">
									<img src="<%=request.getContextPath()%>/restaurantResources/image/user-2.jpg" alt="img" class="img-fluid">
								</div>
							</div>
							<div class="p-4">
								<h5 class="font-weight-bold ellipsis"><a href="blog-detail.html" class="text-reset text-capitalize text-decoration-none">Travel histories global</a></h5>
								<p class="description">
									Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
								</p>
								<a href="blog-detail.html" class="btn pl-3 pr-3 shadow mt-3 mb-2 bg-yellow text-capitalize text-white">read more</a>
					...
					<div class="col-lg-4 col-md-6">
						<div class="shadow-box mt-5 bg-white p-0 restaurant">
							<div class="restaurant-thumbnail p-3 position-relative">
								<small class="et-badge pl-2 pr-2 bg-danger text-white text-uppercase position-absolute">lifestyle</small>
								<iframe class="border-0 position-relative w-100" width="100" height="300" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/118951508&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
								<div class="restaurant-logo rounded-pill shadow overflow-hidden">
									<img src="<%=request.getContextPath()%>/restaurantResources/image/user-1.jpg" alt="img" class="img-fluid">
								</div>
							</div>
